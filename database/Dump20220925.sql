...
INSERT INTO `category_pricing` VALUES (201,75,2201,101),(202,150,2201,102),(203,88,2201,103),(204,170,2201,104),(205,190,2201,105),(206,35,2202,101),(207,110,2202,102),(208,130,2202,103),(209,155,2202,104),(210,175,2202,105),(211,50,2203,101),(212,65,2203,102),(213,90,2203,103),(214,110,2203,104),(215,130,2203,105),(216,99,2204,101),(217,99,2204,102),(218,99,2204,103),(219,99,2204,104),(220,99,2204,105);
...
) ENGINE=InnoDB AUTO_INCREMENT=2211 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `company` VALUES (2201,'Ekart Surface','ekart@gmail.com','Yavatmal',445001,9552333802,1001),(2202,'Ecom Express','ecomexpress@gmail.com','Nagpur',440001,7620809801,1003),(2203,'Bluedart','bluedart321@gmail.com','Nashik',422001,7845129631,1009),(2204,'Delhivery','delhivery789@gmail.com','Nagpur',440001,9654785478,1010),(2205,'Dotzot','dotzot456@gmail.com','Pune',410301,9874561237,1011),(2206,'Fedex','fedex451@gmail.com','Satara',412206,7856234894,1012),(2207,'Rapid Delivery','rapiddelivery@gmail.com','Thane',400601,7418529637,1013),(2208,'Wow Express','wowexpress@gmail.com','Wardha',442001,7539517845,1014),(2209,'Xpressbees','xpressbees@gmail.com','Washim',444004,7845269784,1015),(2210,'Gati SG','gatisg@gmail.com','Akola',444001,9547861237,1016);
...
) ENGINE=InnoDB AUTO_INCREMENT=6003 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `complaint` VALUES (6001,3301,'Recived Damaged Product ','Assign to technical team',2201),(6002,3306,'Customer Care service is some what disappointing ','Complaint is Registered',2202);
...
) ENGINE=InnoDB AUTO_INCREMENT=220350 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `courier_details` VALUES (220343,3301,2201,5001,4001,201,'Darda nagar yavatmal','Ruikar Wadi Yavatmal','true','Shrivardhan Kekapure','Order Pick-up','2022-09-22 19:58:16'),(220344,3302,2202,5007,4007,207,'Yavatmal','Amravati','true','Ankit Hivarkar','Order Pick-up','2022-09-22 23:53:04'),(220345,3303,2201,5004,4004,203,'Wani','Bajoriya Nagar, Yavatmal','true','Gandhali Nival','Order out of Delivery','2022-09-23 00:00:51'),(220346,3304,2202,5009,4010,209,'Near Grampanchayat,Ghuikhed','Near Prince Public School, Gwalior','true','Gayatri Pande','Order out of Delivery','2022-09-23 00:06:41'),(220347,3306,2202,5006,4006,209,'Band Sankul Gajanan Nagar Yavatmal 445001','Ashoka Society, Wadgaon, Nagpur 446001','true','Yash Hajare','Order Pick-up','2022-09-23 22:36:59'),(220348,3302,2201,5004,4004,204,'Ashok Colony, Rahatgaon Road, Wardha','Mayabavti Nagar, near Sai Temple, Nagpur','true','Rahit Bendre','Order out of Delivery','2022-09-25 12:52:35'),(220349,3304,2201,NULL,NULL,205,'Satya Sankul Appartment, Nashik','Gajanan Nagar, Waghapur Road, Nanded','true','Yogesh Parat',NULL,'2022-09-25 13:01:52');
...
) ENGINE=InnoDB AUTO_INCREMENT=3307 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5016 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7003 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `feedback` VALUES (7001,3301,'It is great value for money',2201),(7002,3306,'Something that I really appreciate is fast service',2202);
...
INSERT INTO `users` VALUES (1000,'admin','YWRtaW4=',1,'false'),(1001,'Ekart Surface','ZWthcnRzdXJmYWNl',2,'true'),(1002,'Mayur Pawar','bWF5dXI=',3,'false'),(1003,'Ecom Express','RWNvbUAxMjM=',2,'true'),(1004,'Aman Tekade','QW1hbkAxMjM=',3,'false'),(1005,'Shrivardhan Kekapure','U2hyaXZhcmRoYW5AMTIz',3,'false'),(1006,'Shahaji Ghuikhedkar','U2hhaGFqaUAxMjM=',3,'false'),(1007,'Devashish Barad','RGV2YXNoaXNoQDEyMw==',3,'false'),(1008,'Atharva Thakare','QXRoYXJ2YUAxMjM=',3,'false'),(1009,'Bluedart','Qmx1ZWRhcnRAMTIz',2,'true'),(1010,'Delhivery','RGVsaGl2ZXJ5QDEyMw==',2,'true'),(1011,'Dotzot','RG90em90QDEyMw==',2,'false'),(1012,'Fedex','RmVkZXhAMTIz',2,'false'),(1013,'Rapid Delivery','UmFwaWRAMTIz',2,'false'),(1014,'Wow Express','V293ZXhwcmVzc0AxMjM=',2,'false'),(1015,'Xpressbees','WHByZXNzYmVlc0AxMjM=',2,'false'),(1016,'Gati SG','R2F0aXNnQDEyMw==',2,'false');
...
) ENGINE=InnoDB AUTO_INCREMENT=4016 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vehicles_details` VALUES (4001,'MH31VD0001',2201),(4002,'MH27DA2712',2201),(4003,'MH30SG1130',2201),(4004,'MH29OP0305',2201),(4005,'MH37BQ4566',2201),(4006,'MH40FC3365',2202),(4007,'MH49AL6641',2202),(4008,'MH33PQ5452',2202),(4009,'MH34FD6542',2202),(4010,'MH32GF3165',2202),(4011,'MH34HG3456',2203),(4012,'MH35HG4567',2203),(4013,'MH12LK4578',2203),(4014,'MH23HS7845',2203),(4015,'MH14MP4512',2203);
...
-- Dump completed on 2022-09-25 13:07:22
